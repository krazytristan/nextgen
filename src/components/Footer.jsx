...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-[#7fa95e] to-horizon-green text-white overflow-hidden">
      {/* Gradient divider */}
      <div className="absolute top-0 left-0 w-full h-[4px] bg-gradient-to-r from-horizon-orange via-horizon-amber to-horizon-green" />
      ...
      <div className="relative container py-24">
        ...
        <div className="row gy-6">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={s.label}
                  className="w-11 h-11 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/30 transition shadow"
                >
                  {s.icon}
                </a>
              ))}
          ...
          >
            <h6 className="fw-semibold mb-4 uppercase tracking-wide text-sm">
              Company
            </h6>
          ...
          >
            ...
            <a
              href="#team"
              className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-horizon-orange to-horizon-amber text-white shadow hover:shadow-xl transition"
            >
              Meet the Team →
            </a>
          </motion.div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-white/70 text-sm">
          ...
          <a
            href="#home"
            className="flex items-center gap-2 px-5 py-2 rounded-full bg-white/20 hover:bg-white/30 transition shadow"
          >
            ↑ Back to top
          </a>
        </div>
